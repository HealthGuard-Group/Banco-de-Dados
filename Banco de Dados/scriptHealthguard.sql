...
CREATE TABLE LogAcesso(
    ...
    CONSTRAINT fkLogAcessoUsuario FOREIGN KEY (fkUsuario) REFERENCES Usuario(idUsuario) ON DELETE CASCADE
);
...
CREATE TABLE LogAcoes (
    ...
    CONSTRAINT fkLogAcoes_LogAcesso FOREIGN KEY (fkLogAceso, fkUnidadeAtendimento, fkUsuario)
        REFERENCES LogAcesso(idLogAcesso, fkUnidadeDeAtendimento, fkUsuario) ON DELETE CASCADE
);
...
CREATE TABLE CodigoRecuperacaoSenha (
    ...
    dataCriacao DATETIME DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fkCodigoRecuperacaoSenhaUsuario FOREIGN KEY (fkUsuario) REFERENCES Usuario(idUsuario) ON DELETE CASCADE,
    CONSTRAINT fkCodigoRecuperacaoSenhaPermissoes FOREIGN KEY (fkPermissoes) REFERENCES Permissoes(idPermissoes)
);
